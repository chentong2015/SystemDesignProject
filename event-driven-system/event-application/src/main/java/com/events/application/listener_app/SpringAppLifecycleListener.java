package com.events.application.listener_app;
...
public class SpringAppLifecycleListener implements SmartLifecycle {
    ...
    protected void onApplicationStart() {
        System.out.println("do something when spring application starts");
    }

    protected void onApplicationStop() {
        System.out.println("do something when spring application stops");
    }
}

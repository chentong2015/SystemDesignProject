package com.events.application.listener_app.broadcast;
...
// APP事件的一个广播器
public class MySpringApplicationEventBroadcaster implements ApplicationListener<SpringApplicationEvent> {
